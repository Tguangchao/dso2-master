...
//    std::string path = "/home/changq/Projects/dso/build/bin/cam0/data/"; 
    // std::ifstream fin("/media/tgc/T71/dataset/tum/rgbd_dataset_freiburg2_desk/rgb.txt");
    // std::string path = "/media/tgc/T71/dataset/tum/rgbd_dataset_freiburg2_desk/";

	std::ifstream fin("/media/tgc/T71/dataset/tum/rgbd_dataset_freiburg1_xyz/rgb.txt");
    std::string path = "/media/tgc/T71/dataset/tum/rgbd_dataset_freiburg1_xyz/";
    std::string s0;
    std::getline(fin, s0);
    std::getline(fin, s0);
    std::getline(fin, s0);

	// std::string strFile = "/media/tgc/T71/dataset/tum/rgbd_dataset_freiburg1_xyz/";
	// std::string rgbFile = strFile + "rgb.txt";
	// std::vector<std::string> vstrImageFilenames;
    // std::vector<double> vTimestamps;
    // LoadImages(rgbFile, vstrImageFilenames, vTimestamps);
...
//        long long int time;
		...
		std::cout << " img_road : " << path + imgpath << std::endl;
        cv::Mat img = cv::imread(path + imgpath, 0);


		// std::cout << " img_road : " << strFile + vstrImageFilenames[idx] << std::endl;
        // cv::Mat img = cv::imread(strFile + vstrImageFilenames[idx], 0);
